...
export const STAGE_NESTED_STEPS: Record<string, NestedStepTemplate[]> = {
  ...
  trunk: [
    step("3.1", "Compass Opens Trunk / R&D", "Compass", "Compass receives the project packet from Chief / Project Board, confirms the project goal, the question Trunk must answer, the current boundary, and what evidence is needed before synthesis.", "Compass", "Past Scan / Trunk"),
    step("3.2", "Past Scan / Trunk", "Compass", "Compass reviews old attempts, prior context, saved notes, rejected ideas, lessons learned, and decisions already made. Output: what we already know, what not to repeat, and what old context still matters.", "Compass", "Present Scan / Trunk"),
    step("3.3", "Present Scan / Trunk", "Compass", "Compass reviews the current state, current goal, constraints, active risks, available resources, and what must be true now. Output: the real present situation and the current work boundary.", "Compass", "Future Scan / Trunk"),
    step("3.4", "Future Scan / Trunk", "Compass", "Compass identifies future hooks, later opportunities, expansion paths, later upgrades, and ideas that should stay out of current scope. Output: future opportunities separated from current scope.", "Compass", "Vault Trunk Input / Trunk"),
    step("3.5", "Vault Trunk Input / Trunk", "Vault", "Vault checks money, cost, pricing, sustainability, revenue role, and financial risk. Output: Vault input filed for Compass to combine into the Trunk synthesis.", "Bloom", "Bloom Trunk Input / Trunk"),
    step("3.6", "Bloom Trunk Input / Trunk", "Bloom", "Bloom checks audience, launch path, growth, distribution, retention, and low-money growth paths. Output: Bloom input filed for Compass to combine into the Trunk synthesis.", "Luma", "Luma Trunk Input / Trunk"),
    step("3.7", "Luma Trunk Input / Trunk", "Luma", "Luma checks design trust, readability, accessibility, packaging, UI expectations, and design red flags. Output: Luma input filed for Compass to combine into the Trunk synthesis.", "Compass", "Compass R&D Synthesis / Trunk"),
    step("3.8", "Compass R&D Synthesis / Trunk", "Compass", "Compass combines Past, Present, Future, plus Vault/Bloom/Luma inputs into the deep Trunk R&D file. Output: deep R&D file with history, current reality, future hooks, risks, open questions, and recommended direction.", "Compass", "Boss Brief / Rook Handoff / Trunk"),
    step("3.9", "Boss Brief / Rook Handoff / Trunk", "Compass", "Compass creates the short Boss-facing highlight brief and hands the clean R&D synthesis to Rook for the business-plan / knowledge-packet level. Future hooks stay marked as future hooks, not current scope.", "Rook", "Knowledge Intake / Knowledge"),
  ],
  knowledge: [
