...
export const STAGE_NESTED_STEPS: Record<string, NestedStepTemplate[]> = {
  ...
  trunk: [
    step("wr1-s05", "Trunk Intake / Compass Opens R&D", "Compass", "Compass receives the packet from Chief / Project Board and confirms the project goal, current question, and exactly what Trunk needs to answer.", "Compass", "Past Scan / Trunk"),
    step("wr1-s06", "Past Scan / Trunk", "Compass", "Compass reviews prior history, old attempts, saved memory, old examples, rejected ideas, and lessons learned. Output: what we already know, what not to repeat, and what old context still matters.", "Compass", "Present Scan / Trunk"),
    step("wr1-s07", "Present Scan / Trunk", "Compass", "Compass reviews the current project state, active goal, current constraints, current risks, current resources, and what must be true now. Output: the real present situation and the current decision/work boundary.", "Compass", "Future Scan / Trunk"),
    step("wr1-s08", "Future Scan / Trunk", "Compass", "Compass identifies future hooks, expansion paths, later upgrades, future revenue/design/growth possibilities, and ideas that should stay out of current scope. Output: future opportunities clearly separated from current scope.", "Lane Inputs Gate", "Lane Inputs / Trunk"),
    step(
      "wr1-s09",
      "Lane Inputs / Trunk",
      "Lane Inputs Gate",
      "Group gate: Vault, Bloom, and Luma each add their lane input to Trunk as input to Compass (not separate final decisions). Vault = money/cost/pricing/sustainability/revenue-risk. Bloom = audience/growth/distribution/retention. Luma = design/readability/trust/accessibility/UI-packaging.",
      "Compass",
      "R&D Synthesis / Trunk",
      {
        groupGate: true,
        subChecks: [
          { id: "trunk-lane-vault", label: "Money / cost / pricing / sustainability / revenue-risk input", assignee: "Vault" },
          { id: "trunk-lane-bloom", label: "Audience / growth / distribution / retention input", assignee: "Bloom" },
          { id: "trunk-lane-luma", label: "Design / readability / trust / accessibility / UI-packaging input", assignee: "Luma" },
        ],
      },
    ),
    step("wr1-s10", "R&D Synthesis / Trunk", "Compass", "Compass combines Past + Present + Future plus Vault/Bloom/Luma inputs into a deep R&D file: what happened before, what matters now, what belongs later, risks, open questions, and recommended direction. Future hooks stay marked as future, not current scope.", "Compass", "Boss Brief & Rook Handoff / Trunk"),
    step("wr1-s11", "Boss Brief & Rook Handoff / Trunk", "Compass", "Compass produces a short Boss-facing highlight brief and hands the clean R&D synthesis to Rook for the business-plan / knowledge-packet level. Future hooks remain marked as future hooks, not current scope.", "Rook", "Knowledge Intake / Knowledge"),
  ],
  knowledge: [
