...
export const STAGE_NESTED_STEPS: Record<string, NestedStepTemplate[]> = {
  ...
  trunk: [
    step("trunk-s01", "Compass Opens Trunk / R&D", "Compass", "Compass receives the project packet, confirms the project goal, the question Trunk must answer, the boundary, and what evidence is needed.", "Compass", "Past Scan / Trunk"),
    step("trunk-s02", "Past Scan / Trunk", "Compass", "Compass reviews old attempts, saved context, rejected ideas, lessons learned, prior examples, and decisions already made.", "Compass", "Present Scan / Trunk"),
    step("trunk-s03", "Present Scan / Trunk", "Compass", "Compass reviews current state, current goal, constraints, active risks, available resources, and what must be true now.", "Compass", "Future Scan / Trunk"),
    step("trunk-s04", "Future Scan / Trunk", "Compass", "Compass identifies future hooks, later opportunities, expansion paths, and ideas that should stay out of current scope.", "Compass", "Vault Trunk Input / Trunk"),
    step("trunk-s05", "Vault Trunk Input / Trunk", "Vault", "Vault checks money, cost, pricing, sustainability, revenue role, and financial risk.", "Bloom", "Bloom Trunk Input / Trunk"),
    step("trunk-s06", "Bloom Trunk Input / Trunk", "Bloom", "Bloom checks audience, launch path, growth, distribution, retention, and low-money growth paths.", "Luma", "Luma Trunk Input / Trunk"),
    step("trunk-s07", "Luma Trunk Input / Trunk", "Luma", "Luma checks design trust, readability, accessibility, packaging, UI expectations, and design red flags.", "Compass", "Compass R&D Synthesis / Trunk"),
    step("trunk-s08", "Compass R&D Synthesis / Trunk", "Compass", "Compass combines Past, Present, Future, plus Vault/Bloom/Luma inputs into the deep Trunk R&D file.", "Compass", "Boss Brief / Rook Handoff / Trunk"),
    step("trunk-s09", "Boss Brief / Rook Handoff / Trunk", "Compass", "Compass creates the short Boss-facing highlight brief and hands the clean R&D synthesis to Rook.", "Rook", "Knowledge Intake / Knowledge"),
  ],
  knowledge: [
