...
export const PIPELINE_STAGES: StageDef[] = [
  ...
  },
  {
    ...
    match: ["/ trunk", "compass opens trunk", "compass opens r&d", "trunk intake", "r&d owner", "lane inputs into trunk", "sustainability", "audience", "design and trust"],
    bot: "Compass",
  },
  {
    id: "knowledge",
...
export const STAGE_NESTED_STEPS: Record<string, NestedStepTemplate[]> = {
  ...
  intake: [
    ...
    step("2.5", "Safety and Authority / Intake", "Shield", "Check safety, authority, account, privacy, and public-action risk.", "Compass", "Trunk Intake / Compass Opens R&D"),
  ],
  trunk: [
    step("3.1", "Trunk Intake / Compass Opens R&D", "Compass", "Compass receives the project packet from Chief / Project Board. Compass confirms the project goal, current question, and what Trunk needs to answer.", "Compass", "Past Scan / Trunk"),
...
export const NESTED_STEP_RENAMES: Record<string, string> = {
  ...
  "compass opens trunk / r&d": "Trunk Intake / Compass Opens R&D",
  "compass opens trunk / r&d intake": "Trunk Intake / Compass Opens R&D",
  ...
  "vault trunk input / trunk": "Lane Inputs Into Trunk / Trunk",
  "bloom trunk input / trunk": "Lane Inputs Into Trunk / Trunk",
  "luma trunk input / trunk": "Lane Inputs Into Trunk / Trunk",
