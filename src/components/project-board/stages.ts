...
export const STAGE_NESTED_STEPS: Record<string, NestedStepTemplate[]> = {
  ...
  trunk: [
    step("trunk-s01", "Compass Opens Trunk / R&D Intake", "Compass", "Compass receives the project packet from Chief / Project Board and confirms the project goal, the question Trunk must answer, the current boundary, and what information is needed before synthesis.", "Compass", "Past Scan / Trunk"),
    step("trunk-s02", "Past Scan / Trunk", "Compass", "Review prior history, old attempts, saved memory, rejected ideas, earlier examples, lessons learned, and decisions already made. Output: what we already know, what not to repeat, and what old context still matters.", "Compass", "Present Scan / Trunk"),
    step("trunk-s03", "Present Scan / Trunk", "Compass", "Review the current project goal, current state, current constraints, current risks, available resources, and what must be true now. Output: the real present situation and the current work boundary.", "Compass", "Future Scan / Trunk"),
    step("trunk-s04", "Future Scan / Trunk", "Compass", "Identify future hooks, expansion paths, later upgrades, later revenue/design/growth possibilities, and ideas that should stay out of current scope. Output: future opportunities separated from current scope.", "Compass", "Lane Inputs Into Trunk / Trunk"),
    step(
      "trunk-s05",
      "Lane Inputs Into Trunk / Trunk",
      "Compass",
      "Compass collects lane inputs from Vault, Bloom, and Luma where useful. Vault: money, cost, pricing, sustainability, revenue role, financial risk. Bloom: audience, growth, distribution, retention, launch path. Luma: design trust, readability, accessibility, UI/product polish risks. These are inputs to Compass, not separate final decisions.",
      "Compass",
      "Compass R&D Synthesis / Trunk",
      {
        groupGate: true,
        subChecks: [
          { id: "trunk-lane-vault", label: "Money, cost, pricing, sustainability, revenue role, financial risk", assignee: "Vault" },
          { id: "trunk-lane-bloom", label: "Audience, growth, distribution, retention, launch path", assignee: "Bloom" },
          { id: "trunk-lane-luma", label: "Design trust, readability, accessibility, UI/product polish risks", assignee: "Luma" },
        ],
      },
    ),
    step("trunk-s06", "Compass R&D Synthesis / Trunk", "Compass", "Combine Past, Present, Future, plus Vault/Bloom/Luma inputs into one Trunk R&D synthesis. Output: deep R&D file with history, current reality, future hooks, risks, open questions, and recommended direction.", "Compass", "Boss Brief / Rook Handoff / Trunk"),
    step("trunk-s07", "Boss Brief / Rook Handoff / Trunk", "Compass", "Produce a short Boss-facing highlight brief and hand the clean R&D synthesis to Rook for the business-plan / knowledge-packet level. Future hooks stay marked as future hooks, not current scope.", "Rook", "Knowledge Intake / Knowledge"),
  ],
  knowledge: [
