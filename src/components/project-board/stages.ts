...
export const STAGE_NESTED_STEPS: Record<string, NestedStepTemplate[]> = {
  ...
  trunk: [
    step("trunk-s01", "Compass Opens Trunk / R&D", "Compass", "Compass receives the project packet from Chief / Project Board, confirms the project goal, the question Trunk must answer, the current boundary, and what evidence is needed before synthesis.", "Compass", "Past Scan / Trunk"),
    step("trunk-s02", "Past Scan / Trunk", "Compass", "Compass reviews old attempts, prior context, saved notes, rejected ideas, lessons learned, and decisions already made. Output: what we already know, what not to repeat, and what old context still matters.", "Compass", "Present Scan / Trunk"),
    step("trunk-s03", "Present Scan / Trunk", "Compass", "Compass reviews the current state, current goal, constraints, active risks, available resources, and what must be true now. Output: the real present situation and the current work boundary.", "Compass", "Future Scan / Trunk"),
    step("trunk-s04", "Future Scan / Trunk", "Compass", "Compass identifies future hooks, later opportunities, expansion paths, later upgrades, and ideas that should stay out of current scope. Output: future opportunities separated from current scope.", "Compass", "Vault Trunk Input / Trunk"),
    step("trunk-s05", "Vault Trunk Input / Trunk", "Vault", "Vault checks money, cost, pricing, sustainability, revenue role, and financial risk. Output: Vault input filed for Compass to combine into the Trunk synthesis.", "Bloom", "Bloom Trunk Input / Trunk"),
    step("trunk-s06", "Bloom Trunk Input / Trunk", "Bloom", "Bloom checks audience, launch path, growth, distribution, retention, and low-money growth paths. Output: Bloom input filed for Compass to combine into the Trunk synthesis.", "Luma", "Luma Trunk Input / Trunk"),
    step("trunk-s07", "Luma Trunk Input / Trunk", "Luma", "Luma checks design trust, readability, accessibility, packaging, UI expectations, and design red flags. Output: Luma input filed for Compass to combine into the Trunk synthesis.", "Compass", "Compass R&D Synthesis / Trunk"),
    step("trunk-s08", "Compass R&D Synthesis / Trunk", "Compass", "Compass combines Past, Present, Future, plus Vault/Bloom/Luma inputs into the deep Trunk R&D file. Output: deep R&D file with history, current reality, future hooks, risks, open questions, and recommended direction.", "Compass", "Boss Brief / Rook Handoff / Trunk"),
    step("trunk-s09", "Boss Brief / Rook Handoff / Trunk", "Compass", "Compass creates the short Boss-facing highlight brief and hands the clean R&D synthesis to Rook for the business-plan / knowledge-packet level. Future hooks stay marked as future hooks, not current scope.", "Rook", "Knowledge Intake / Knowledge"),
  ],
  knowledge: [
    step("wr1-s12", "Knowledge Intake / Knowledge", "Rook", "Accept the project packet and start the Knowledge level.", "Squirrel Gate / Assigned Check Bots", "Narrow Checks / Knowledge"),
    step(
      "wr1-s13",
    ...
    step("wr1-s14", "Practical Design Input / Knowledge", "Luma", "Return practical design input for Rook's Knowledge packet.", "Vault", "Practical Money Input / Knowledge"),
    step("wr1-s15", "Practical Money Input / Knowledge", "Vault", "Return practical money input for Rook's Knowledge packet.", "Bloom", "Practical Growth Input / Knowledge"),
    step("wr1-s16", "Practical Growth Input / Knowledge", "Bloom", "Return practical audience and growth input for Rook's Knowledge packet.", "Rook", "Tinker-Ready Packet / Knowledge"),
    step("wr1-s17", "Tinker-Ready Packet / Knowledge", "Rook", "Assemble the clean Tinker-ready packet.", "Tinker", "Tinker Intake / Experiment"),
  ],
  experiment: [
    step("wr1-s18", "Tinker Intake / Experiment", "Tinker", "Accept the Rook packet and organize the Experiment branch.", "Squirrel Gate / Assigned Squirrels", "Squirrel Help / Experiment"),
    step(
      "wr1-s19",
    ...
    step("wr1-s20", "Trunk Help / Experiment", "Lantern Gate / Shield", "Coordinate trunk help through Lantern; Shield handles safety/authority only if called.", "Echo", "Pre-Momma Memory Alignment / Experiment"),
    step("wr1-s21", "Pre-Momma Memory Alignment / Experiment", "Echo", "Run the standard pre-Momma memory alignment check.", "Momma", "Momma Package Prep / Experiment"),
    step("wr1-s22", "Momma Package Prep / Experiment", "Momma", "Prepare the neutral Build-A-Bears package for the Bears group.", "Build-A-Bears Gate", "Baby Bear Directions / Experiment"),
    step("wr1-s23", "Baby Bear Directions / Experiment", "Build-A-Bears Gate", "Group gate: Ace, Bolt, and Craft create independent Bear directions and return receipts.", "Momma", "Bear Output Collection + Master Prompt Assembly / Experiment", { groupGate: true }),
    step("wr1-s24", "Bear Output Collection + Master Prompt Assembly / Experiment", "Momma", "Collect Bear outputs and assemble the Master Prompt.", "Echo", "Echo Lovable Build Pass / Experiment"),
    step("wr1-s25", "Echo Lovable Build Pass / Experiment", "Echo", "Review the Master Prompt and hold Lovable submission until approval is clear.", "Boss / Tinker / Chief", "Project Overlook / Next Movement Review / Experiment"),
    step("wr1-s26", "Project Overlook / Next Movement Review / Experiment", "Boss / Tinker / Chief", "Review the project result and decide the next movement.", "Echo", "Memory Alignment / Branch Gate"),
  ],
  "branch-gate": [
    step("wr1-s27", "Memory Alignment / Branch Gate", "Echo", "Run memory alignment before the next major branch handoff.", "Weaver", "Package Intake and Review / Weaver"),
  ],
  weaver: [
    step("wr1-s28", "Package Intake and Review / Weaver", "Weaver", "Accept the package and begin Weaver-level package review.", "Byte / Bubba", "Byte + Bubba Prototype Handoff / Weaver"),
    step("wr1-s29", "Byte + Bubba Prototype Handoff / Weaver", "Byte / Bubba", "Review prototype/build handoff needs and return next-slice guidance.", "Squirrel Gate / Assigned Squirrels", "Squirrel Checks / Weaver"),
    step(
      "wr1-s30",
    ...
    step("wr1-s31", "Trunk Checks / Weaver", "Lantern Gate / Shadows Gate / Requested Groups", "Each group returns Completed or Blocked.", "Weaver", "Review and Final Package / Weaver", { groupGate: true }),
    step("wr1-s32", "Review and Final Package / Weaver", "Weaver", "Assemble the reviewed final package and return Completed or Blocked.", "High Council Gate", "High Council Review / Council"),
  ],
  council: [
    step("wr1-s33", "High Council Review / Council", "High Council Gate", "Group gate: complete High Council review and return Completed or Blocked.", "Ward", "Intake & Install / Ward", { groupGate: true }),
  ],
  ward: [
    step("wr1-s34", "Intake & Install / Ward", "Ward", "Accept the final package for Ward-level intake and install planning. Final canonical row.", undefined, "Workflow Complete"),
  ],
};
...
export const NESTED_STEP_RENAMES: Record<string, string> = {
  ...
  "lantern team kickoff / r&d": "Compass Opens Trunk / R&D Intake",
  "r&d owner / trunk": "Compass Opens Trunk / R&D Intake",
  "trunk intake / compass opens r&d": "Compass Opens Trunk / R&D Intake",
  ...
  "money and sustainability input / trunk": "Lane Inputs Into Trunk / Trunk",
  "audience and growth input / trunk": "Lane Inputs Into Trunk / Trunk",
  "design and trust input / trunk": "Lane Inputs Into Trunk / Trunk",
  "lane inputs / trunk": "Lane Inputs Into Trunk / Trunk",
